from deepvoice3.model import AttentionSeq2Seq, MultiSpeakerTTSModel
from deepvoice3.seq2seq.converter import Converter
from deepvoice3.seq2seq.decoder import Decoder
from deepvoice3.seq2seq.encoder import Encoder


def deepvoice3_model(
    n_vocab,
    embed_dim=256,
    mel_dim=80,
    linear_dim=513,
